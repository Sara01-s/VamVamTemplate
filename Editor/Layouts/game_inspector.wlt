...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: ShaderPreview
--- !u!114 &6
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -599.5
    m_HBaseRangeMax: 599.5
    m_VBaseRangeMin: -337.2
    m_VBaseRangeMax: 337.2
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1498.75, y: 877.25}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
