...
namespace VVT.Runtime {
    ...
    public sealed partial class FMODAudioController : MonoBehaviour, ISettingsDataPersistant, IFMODAudioService {
        ...
        private void Awake() {
            Services.Instance.RegisterService<IFMODAudioService>(this);
        ...
        private void OnDisable() {
            Services.Instance.UnRegisterService<IFMODAudioService>();
        }
